...
public class AgendaFrame 
{
	...
	public void makeFrame()
	{
		...
		button.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				addData(artist.getText(), Integer.parseInt(popu.getText()), podi.getText(), Stijd.getText(), Etijd.getText());
				artist.setText(""); 
				popu.setText("");
				podi.setText("");
				Stijd.setText("");
	...
	{
		datas.add(new Act(artist,pop,stage,sTijd,eTijd));
	}
