...
public class Map {
   ...
   private static int yLength = 500;
   ...
   public void drawEntrance(Graphics g) {
       ...
       calculate();
       Rectangle2D rectangle = new Rectangle2D.Double(xTotal+40,-40,90,80);
       g2.setColor(c);
       g2.fill(rectangle);
   }
   ...
   public void drawTree(Graphics g) {
       ...
       calculate();
       for(int x = -xTotal-60; x <= xTotal+90; x += 30) {
           for(int y = -yTotal-60; y <= yTotal+90; y += 30) {
             Ellipse2D e1 = new Ellipse2D.Double(x+5,y+20,5,10); //Stam
             Ellipse2D e2 = new Ellipse2D.Double(x,y,15,25); //Bladeren
             Ellipse2D e3 = new Ellipse2D.Double(x+5,y+10,10,15); //Bladeren
             g2.setColor(c1);
             g2.fill(e1);
             g2.setColor(c2);
             g2.fill(e2);
   ...
   public void drawMountain(Graphics2D g) {
       ...
       Rectangle2D firstLayer = new Rectangle2D.Double(-xTotal-225,-yTotal-225,xLength+500,yLength+500);
       Rectangle2D secondLayer = new Rectangle2D.Double(-xTotal-125,-yTotal-125,xLength+300,yLength+300);     
       g2.setColor(c1);
       g2.fill(firstLayer);
       g2.setColor(c2);
       g2.fill(secondLayer);       
   ...
   public void drawField(Graphics g) { 
       Graphics2D g2 = (Graphics2D)g;
       calculate();
       Rectangle2D rectangle = new Rectangle2D.Double(-xTotal,-yTotal,xLength+40,yLength+40);
   ...
   public void drawGRID(Graphics g){    
       Graphics2D g2 = (Graphics2D)g;
       calculate();
       for(int x = -xTotal; x <= xTotal; x += 20) {
           for(int y = -yTotal; y <= yTotal; y += 20) {
               //direction.get(y).get(x).draw(g,x,y);
               Rectangle2D rec = new Rectangle2D.Double(x,y,40,40);
